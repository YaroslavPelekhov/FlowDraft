...
OUT_DIR="${OUT_DIR:-/workspace/flowdraft_runs/eagleflow_attention_screen_300_r1}"
...
log "Strict FP32 greedy losslessness gate; TPF counts frozen verifier forwards"
...
log "EagleFlow run complete: $OUT_DIR"
