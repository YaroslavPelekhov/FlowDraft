...
log "CacheFlow resource preflight"
"$PYTHON_BIN" scripts/inspect_resources.py --paths / /workspace /dev/shm
log "Training one-pass hidden trajectory CacheFlow head"
"$PYTHON_BIN" scripts/train_cacheflow.py \
  --config configs/cacheflow_probe.yaml \
